...
let DrugsService = class DrugsService {
    ...
    async getDrugsByFirstLetter(letter) {
        ...
        try {
            ...
            await this.drugRepository.delete({ name: (0, typeorm_2.ILike)(`${letter}%`) });
